  ...
  return (
    <BaseLayout>
      ...
      <div className='container flex flex-col items-center justify-start w-full min-h-screen px-2 pt-48 mx-auto space-y-4'>
        <h1 className='z-0 text-4xl font-bold text-center text-catalina-blue-900'>Selamat Datang di Website Saya</h1>
        <p className='z-0 text-xl font-normal text-center text-catalina-blue-900'>Saya adalah Seorang Fullstack Web Developer</p>
        <span className='z-0 text-lg font-normal text-center text-catalina-blue-900'>lebih lanjut tentang saya</span>
        <button className='z-0 text-catalina-blue-900 animate-bounce' onClick={() => window.scrollTo({ top: window.innerHeight, behavior: 'smooth' })}>
